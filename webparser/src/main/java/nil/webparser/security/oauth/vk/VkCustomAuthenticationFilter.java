package nil.webparser.security.oauth.vk;
...
public class VkCustomAuthenticationFilter extends AbstractAuthenticationProcessingFilter {

    private OAuth2RestOperations restTemplate;
    private VkUserInfoTokenService tokenServices;

    public VkCustomAuthenticationFilter(String defaultFilterProcessesUrl) {
